 ...
 *         &lt;element name="as_at_date" type="{http://www.w3.org/2001/XMLSchema}dateTime"/&gt;
...
@XmlRootElement(name = "get_overdueinvoices")
public class GetOverdueinvoices {

    protected int unitid;
    @XmlElement(name = "as_at_date", required = true)
